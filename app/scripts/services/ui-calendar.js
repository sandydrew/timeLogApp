 ...
 *
 *  Modified by sdrew to look for the entryDate in the parent scope to set the current date.
 */
    ...
    .directive('uiCalendar', ['uiCalendarConfig', '$locale', function (uiCalendarConfig, $locale) {
        ...
        return {
            ...
            link: function (scope, elm, attrs, controller) {
                ...
                var eventSourcesWatcher = controller.changeWatcher(sources, controller.sourcesFingerprint);
                var eventsWatcher = controller.changeWatcher(controller.allEvents, controller.eventsFingerprint);
                var options = null;
                ...
                if (typeof scope.$parent !== 'undefined') {
                    if (typeof scope.$parent.entryDate !== 'undefined') {
                        scope.calendar.fullCalendar('gotoDate', scope.$parent.entryDate);
                    }
                }
